            ...
            <div className="card-left">
                <div className="card-image-wrapper">
                    ...
                    <div className="card-content">
                        ...
                        <button className="button button1" onClick={onOrderClick}>Sipariş Ver</button>
                    </div>
                </div>
            </div>
            ...
            <div className="card-right">
                <div className="card-image-wrapper">
                    ...
                    <div className="card-content card-content2">
                        <h2>Hackathlon</h2>
                        <p>Burger Menü</p>
                        <button className="button button2" onClick={onOrderClick}>Sipariş Ver</button>
                    </div>
                </div>
